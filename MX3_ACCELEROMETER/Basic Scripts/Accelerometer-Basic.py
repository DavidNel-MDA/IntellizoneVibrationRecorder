...
while True:
    ...
    print("Acceleration (m/s²): X={:.2f} Y={:.2f} Z={:.2f}".format(accel_x, accel_y, accel_z))
    print("Magnetic field (Gauss): X={:.2f} Y={:.2f} Z={:.2f}".format(mag_x_gauss, mag_y_gauss, mag_z_gauss))
